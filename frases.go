...
var jogos = []string{
	...
	"Dota 2 (Martelinho mid)",
	"Dota 2 (Outworld Devourer mid)",
	"Dota 2 (Outworld Destroyer mid)",
	"Dota 2 (Obsidian Destroyer mid)",
	"Dota 2 (Obsidian Devourer mid)",
	"Dota 2 (Outworld Developer mid)",
	"Dota 2 (Outhouse Decorator mid)",
	"Dota 2 (Outworld Demolisher mid)",
	"Warcraft III",
	"Poketibia",
	"CSGO",
	"Grand Chase",
